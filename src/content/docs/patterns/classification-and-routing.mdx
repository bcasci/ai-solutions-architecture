...
:::tip
Use [structured output](/foundations/structured-output) for the classification step. Returning a constrained category name (not free-form text) eliminates parsing errors in the routing logic.
:::
...
- [Tool Use](/patterns/tool-use) --- give specialized handlers access to external tools
- [Structured Output](/foundations/structured-output) --- enforce clean classifier output for routing
- [System Prompts](/foundations/system-prompts) --- tune each handler with role-specific context
- [Evaluation & Testing](/patterns/evaluation) --- measure whether routing improves response quality
