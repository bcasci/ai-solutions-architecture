...
- [Tool Use](/patterns/tool-use) — give Claude tools to query your RAG pipeline dynamically
- [System Prompts](/foundations/system-prompts) — craft the generation prompt for RAG responses
- [Structured Output](/foundations/structured-output) — extract structured data from retrieved chunks
- [Cost Optimization](/production/cost-optimization) — RAG reduces per-query token cost
- [Evaluation](/patterns/evaluation) — measure RAG retrieval and answer quality
