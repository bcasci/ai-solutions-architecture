...
**Start with direct tool definitions** if you're building one app with a handful of custom tools. **Move to MCP** when you find yourself duplicating tool definitions across projects, want to share tools across a team, or want to use the growing ecosystem of pre-built MCP servers.
