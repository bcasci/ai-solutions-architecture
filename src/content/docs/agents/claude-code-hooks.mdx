...
- [Claude Code: Basics & Context](/agents/claude-code-basics) — CLAUDE.md setup and context management
- [Claude Code: Skills & SDK](/agents/claude-code-skills) — reusable instructions and programmatic control
